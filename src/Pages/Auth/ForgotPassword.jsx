        ...
        <MuiThemeProvider theme={mainTheme}>
          <div className={classes.root}>
            <div className={classes.container}>
              <Paper className={classes.paperForgotPassword}>
                <Avatar className={classes.avatarForgotPassword}>
                  <EmailIcon />
                </Avatar>
                <Typography
                  variant="headline"
                  className={classes.titleForgotPassword}
                >
                ...
                {this.state.verificationCodeisHidden ? null : (
